...
instance Show1 f => Show1 (Freer f) where
  liftShowsPrec sp sl = go
    where go d r = case r of
            ...
            Map f a -> showsBinaryWith (const showString) (liftShowsPrec ((. f) . sp) (sl . fmap f)) "Map" d "_" a
